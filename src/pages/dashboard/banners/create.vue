            ...
            <v-row>
                ...
                <v-col sm="12" md="10" style="margin-top: 16px;">
                    ...
                    <v-col cols="12" md="6">
                        ...
                        <v-btn  class="icon"  @click.prevent="add_banner()"  :loading="isloading" append-icon="mdi:arrow-right" variant="tonal" height="60px" width="100%" rounded
...
<script setup>
    import { addBanners } from "@/composables/requests/banners"
    ...
    const add_banner = async()=>{
        ...
        try{
            const data = await addBanners(payload)
            if(data.success){
